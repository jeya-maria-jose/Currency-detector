...
syn1 = np.random.random((10,10))   # 4x1 matrix of weights. (4 nodes x 1 output) - no bias term in the hidden layer.
syn2 =np .random.random((10,10)) 
syn3 = np.random.random((10,1)) 
...
for j in range(1000):  
    ...
    syn3 += l3.T.dot(l4_delta)*0.001
    syn2 += l2.T.dot(l3_delta)*0.001
